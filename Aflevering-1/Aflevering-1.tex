...
1+3+x+x+x+x+x+5/4 \cdot 2 & = 42 \\
         4+5x+5/4 \cdot 2 & = 42
\end{align*}
Umiddelbart skulle man tro at løsningen var 7.1, men dette er ikke tilfældet. Årsagen er at compileren følger almen operatorprioritet. Resultatet af \code{5/4*2} bliver altså regnet først. 5,4 og 2 integers, hvorved resultatet af den første division, \code{5/4}, bliver afkortet til 2. Så vores regnestykke ser faktisk således ud:
$$ 4+5x+2 = 42 $$
